...
try {
    ...
    $query = "SELECT * FROM devis WHERE id_devis = :id";
    ...
    $_SESSION['error'] = "Erreur lors de la modification du devis: " . $e->getMessage();
}
        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="card-title mb-0">Modifier le Devis</h5>
                </div>
                <div class="card-body">
                    ...
                    <form method="post">
                            ...
                            <select class="form-select" id="id_entreprise" name="id_entreprise" required>
                                <?php foreach($entreprises as $entreprise): ?>
                                    <option value="<?= $entreprise['id_entreprise'] ?>" 
                                            <?= $devis['id_entreprise'] == $entreprise['id_entreprise'] ? 'selected' : '' ?>>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="montant_total" 
                                           name="montant_total" value="<?= $devis['montant_total'] ?>" 
                                           step="0.01" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="validite_jours" 
                                       name="validite_jours" value="<?= $devis['validite_jours'] ?>" 
                                       min="1" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="statut" name="statut" required>
                                ...
                                <option value="expiré" <?= $devis['statut'] == 'expiré' ? 'selected' : '' ?>>Expiré</option>
                            </select>
                        </div>
