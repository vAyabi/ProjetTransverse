...
try {
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $result = callAPI('contrat/create.php', 'POST', $data);
        ...
        if ($result && isset($result['status']) && $result['status']) {
            ...
            throw new Exception(isset($result['message']) ? $result['message'] : "Erreur lors de l'ajout du contrat");
        }
    }
        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                <div class="card-header bg-success text-white">
                    <h5 class="card-title mb-0">Nouveau Contrat</h5>
                </div>
                <div class="card-body">
