...
$evenement->id_entreprise = intval($_GET["id_entreprise"]);

$stmt = $evenement->findByEntreprise();
$num = $stmt->rowCount();
...
if ($num > 0) {
    ...
    ApiResponse::success(array("evenements" => array()), "Aucun événement trouvé pour cette entreprise");
}