...
if (empty($_GET["specialite"])) {
    ApiResponse::error("Spécialité requise", 400);
    exit;
}
...
$prestataire->specialite = $_GET["specialite"];

$stmt = $prestataire->findBySpecialite();
$num = $stmt->rowCount();
...
if ($num > 0) {
    ...
    ApiResponse::success(array("prestataires" => array()), "Aucun prestataire trouvé pour cette spécialité");
}